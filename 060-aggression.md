...
- Can bot Secure the Imperial Council? <span style="font-size: 12px;">[3]</span>
<#endif>

✦ Can bot favorable combat to contend a declared ambition? <span style="font-size: 12px;">[4]</span>
...
✦ Can bot Secure any other card? <span style="font-size: 12px;">[36]</span>
